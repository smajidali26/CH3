...
using CH3.Core.Infrastructure.Mapper;
...
namespace CH3.Core.Infrastructure
{
    /// <summary>
    /// Represents Nop engine
    /// </summary>
    public class CH3Engine : IEngine
    {
        #region Properties
        ...
        /// <param name="typeFinder">Type finder</param>
        protected virtual IServiceProvider RegisterDependencies(CH3Config nopConfig, IServiceCollection services, ITypeFinder typeFinder)
        {
        ...
        public void Initialize(IServiceCollection services)
        {
            ...
            var nopConfig = provider.GetRequiredService<CH3Config>();
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services, IConfigurationRoot configuration)
        {
            ...
            var nopConfig = services.BuildServiceProvider().GetService<CH3Config>();
        ...
        public virtual object ResolveUnregistered(Type type)
        {
            ...
            foreach (var constructor in type.GetConstructors())
            {
                try
                {
                    ...
                    var parameters = constructor.GetParameters().Select(parameter =>
                    {
                        ...
                        if (service == null)
                            throw new CH3Exception("Unknown dependency");
                        return service;
                    });
            ...
            throw new CH3Exception("No constructor was found that had all the dependencies satisfied.", innerException);
        }
