...
namespace CH3.Data
{
    public class CH3ObjectContext :DbContext,IDbContext
    {
        #region Ctor
        ...
        public CH3ObjectContext(string nameOrConnectionString)
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            .Where(type => type.BaseType != null && type.BaseType.IsGenericType &&
                type.BaseType.GetGenericTypeDefinition() == typeof(CH3EntityTypeConfiguration<>));
